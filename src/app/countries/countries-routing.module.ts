...
@NgModule(
    {
      imports: [
        /*Este routerModule es un modulo de Angular, no es que estemos importando el que está definido
        app-routing.module */
        RouterModule.forChild(routes)
      ],
      exports: [
        //Aca lo exportamos para que este visible para los otros componentes. Al igual que exportamos el de lapp-routing.module.
        RouterModule
      ]
    }
    )
